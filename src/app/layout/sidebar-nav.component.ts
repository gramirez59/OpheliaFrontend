...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [       
        new MenuItem('Clientes', 'Pages.Clientes', 'people', '/app/clientes'),
        new MenuItem('Productos', 'Pages.Productos', 'local_offer', '/app/productos'),
        new MenuItem('Ventas', 'Pages.Ventas', 'business', '/app/ventas'),
        new MenuItem('Total vendido por producto', 'Pages.Ventas', 'business', '/app/ventas-por-producto'),
